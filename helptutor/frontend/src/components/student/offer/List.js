...
import { deleteStudentOffer } from '../../../services/Student';
...
export default function List(props) {
  ...
  const onDelete = (id) => {
    ...
    deleteStudentOffer(id).then((res) => {
      setList(list.filter((item) => item.id != id));
      dispatch({ type: ACTION_END });
      dispatch(createMessage('Oferta eliminada'));
    });
  };
  ...
  return (
    <div className=''>
      <div className='header-list'>
        <span className='title-component'>Mis ofertas</span>
